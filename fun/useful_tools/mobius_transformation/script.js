...
// Sphere Base
{
  ...
  const material = new THREE.MeshBasicMaterial( {side: THREE.DoubleSide, color: 0x1A69B5, opacity: 0.5, transparent:true} );
  const sphere = new THREE.Mesh( geometry, material );
  scene.add( sphere );
}

// Add Points
const geometry0 = new THREE.SphereGeometry( 0.025, 32, 32 );
const material0 = new THREE.MeshBasicMaterial( {side: THREE.DoubleSide, color: 0xFFFFFF} );
